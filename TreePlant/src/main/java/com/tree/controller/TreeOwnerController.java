...
public class TreeOwnerController {
    ...
    public ResponseEntity<TreeOwner> createOwner(@RequestBody TreeOwner treeOwner) {
        return ResponseEntity.ok(treeOwnerService.createOwner(treeOwner));
    }
    ...
    public ResponseEntity<String> updatePassword(@RequestBody Map<String, String> request) {
        return ResponseEntity.ok(treeOwnerService.updatePassword(request.get("username"), request.get("oldPassword"), request.get("newPassword")));
    }
